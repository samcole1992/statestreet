This project can be started using npm start

Style is at a minimum, using react-bootstrap for the grid layout

Because there is no backend, all the data manipulation happens on the front-end, which affects performance. If I was going to create a similar project I would do the data manipulation in an RESTful API and not in the front end.
