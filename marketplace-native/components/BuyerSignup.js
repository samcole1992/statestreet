...
const BuyerSignup = ({ onSignInClick, onContinueClick, authenticating}) => {
  ...
  if (authenticating) {
    ...
    continueLink =  (
      <TouchableOpacity onPress={() => onContinueClick()}>
        <Text style={styles.signupLink}>Sign up as Buyer</Text>
      </TouchableOpacity>
    )
  }
  ...
  return(
    ...
    <View style={{height, backgroundColor: 'white'}}>
      <View>
        <Text style={ styles.signUpHeader }>Signup as Buyer</Text>
      </View>
      <View>
        <Field
          name={'email'}
